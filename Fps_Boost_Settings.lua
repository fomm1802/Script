...
local SharedUI = ReplicatedStorage:WaitForChild("SharedUI", 60)
...
-- Load user settings on startup, default to "Ultra Low"
local settingsData = loadSettings()
local selectedLevel = settingsData.level or "Ultra Low"
...
statusLabel.Position = UDim2.new(0, 15, 0, 200)
...
buttonContainer.Size = UDim2.new(1, -30, 0, 150)
